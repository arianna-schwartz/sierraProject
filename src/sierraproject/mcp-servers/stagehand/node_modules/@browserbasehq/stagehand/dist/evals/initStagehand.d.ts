 ...
 */
import { AvailableModel, ConstructorParams, LLMClient, Stagehand } from "@/dist";
 ...
 */
export declare const initStagehand: ({ llmClient, modelName, domSettleTimeoutMs, logger, configOverrides, actTimeoutMs, }: {
    llmClient?: LLMClient;
