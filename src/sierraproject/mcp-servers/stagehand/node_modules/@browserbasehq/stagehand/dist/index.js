    ...
    if (env === "BROWSERBASE") {
      ...
      if (browserbaseSessionID) {
        try {
          ...
          const session = yield browserbase.sessions.retrieve(sessionId);
      ...
      if (localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.cdpUrl) {
        ...
        const browser = yield import_test2.chromium.connectOverCDP(
...
var Stagehand3 = class {
  constructor({
    ...
    } else if (this.usingAPI && this.llmClient && this.llmClient.type !== "openai" && this.llmClient.type !== "anthropic") {
